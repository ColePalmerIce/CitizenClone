...
const handleActionClick = (actionType: string, onAccountClick: () => void, setIsCreditCardToolOpen: (open: boolean) => void) => {
  switch (actionType) {
    case "account":
      onAccountClick();
      break;
              ...
              {actions.map((action) => {
                ...
                return (
                  <Card 
                    ...
                    onClick={() => handleActionClick(action.onClick, onAccountClick, setIsCreditCardToolOpen)}
